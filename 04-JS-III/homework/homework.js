...
// var indice = array.indexOf(elemento)
  //if (indice === -1) { return false }   ESTA FORMA TAMBIEN ESTÁ ACEPTADA
  //else { return true }
...
for (let i = 0; i < arreglo.length; i++) {
  if (arreglo[i] > 18) { mayorA18.push(arreglo[i]) };
...
function mayorACien(array) {
  ...
  //var mayorA100 = array.filter(element => element>100)   OTRA SOLUCIÓN
  //return mayorA100
  var mayoresA100 = []
  for (let i = 0; i < array.length; i++) {
